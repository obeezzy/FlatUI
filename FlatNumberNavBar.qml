...
Rectangle {
    ...
    property color separatorColor: "#E3E7EA" //flatConstants.clouds
...
//    property color separatorColor: "#E3E7EA"
    ...
    FlatIconButton {
        ...
        width: 50
        text: flatConstants.glyphFont.leftStickArrow
    ...
    ListView {
        ...
        Text {
            ...
            color: root.checkedIndex == -1 ? "transparent" : flatConstants.turquoise
            opacity: 0
